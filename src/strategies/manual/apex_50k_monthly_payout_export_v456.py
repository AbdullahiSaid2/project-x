...
def main() -> None:
    ...
    out_dir = Path(".")
    excel_path = out_dir / "v456_apex_50k_monthly_payout_export.xlsx"
    monthly_csv = out_dir / "v456_apex_50k_monthly_summary.csv"
    daily_csv = out_dir / "v456_apex_50k_daily_summary.csv"
    trades_csv = out_dir / "v456_apex_50k_trade_log.csv"
