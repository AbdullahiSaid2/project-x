...
from src.strategies.manual.ict_multi_setup_v42 import ICT_MULTI_SETUP_V42
...
print("\n5) Debug counters...")
for k, v in ICT_MULTI_SETUP_V42.last_debug_counts.items():
    print(f"{k}: {v}")

print("\n6) Trade metadata log...")
if ICT_MULTI_SETUP_V42.last_trade_log:
    meta_df = pd.DataFrame(ICT_MULTI_SETUP_V42.last_trade_log)
