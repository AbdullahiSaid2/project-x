...
if trades is not None:
    ...
    if not trades.empty:
        ...
        print(trades.tail(40))

print("\n5) Debug counters...")
for k, v in ICT_MULTI_SETUP_V43.last_debug_counts.items():
    print(f"{k}: {v}")

print("\n6) Trade metadata log...")
if ICT_MULTI_SETUP_V43.last_trade_log:
    meta_df = pd.DataFrame(ICT_MULTI_SETUP_V43.last_trade_log)
    print(meta_df.tail(40))
else:
