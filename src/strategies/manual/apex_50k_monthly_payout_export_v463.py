...
def main() -> None:
    ...
    output_excel = Path("v463_apex_50k_monthly_payout_export.xlsx")
    output_monthly_csv = Path("v463_apex_50k_monthly_summary.csv")
    output_daily_csv = Path("v463_apex_50k_daily_summary.csv")
    output_trades_csv = Path("v463_apex_50k_trade_log.csv")
