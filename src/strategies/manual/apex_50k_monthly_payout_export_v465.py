...
from src.strategies.manual.reporting_v465 import load_strategy_meta, save_excel_with_naive_datetimes
...
def main() -> None:
    ...
    output_excel = Path("v465_apex_50k_monthly_payout_export.xlsx")
    output_monthly_csv = Path("v465_apex_50k_monthly_summary.csv")
    output_daily_csv = Path("v465_apex_50k_daily_summary.csv")
    output_trades_csv = Path("v465_apex_50k_trade_log.csv")
