...
import pandas as pd
from v472_shared import OUT_TRADE_CSV, run_all_symbols


def main():
    print("1) Running V472 multi-instrument build...")
    print("✅ Base logic: v452 preserved | symbols = NQ, MES, MYM, MGC, MCL | Apex 50k reporting layer")
    df = run_all_symbols(["NQ", "MES", "MYM", "MGC", "MCL"])
    if df.empty:
