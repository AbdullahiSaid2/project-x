...
from src.strategies.manual.ict_multi_setup_v452 import ICT_MULTI_SETUP_V452
...
meta = pd.DataFrame(ICT_MULTI_SETUP_V452.last_trade_log)
if meta.empty:
...
# Output files
output_xlsx = Path("v452_apex_50k_monthly_payout_export.xlsx")
output_csv_monthly = Path("v452_apex_50k_monthly_summary.csv")
output_csv_daily = Path("v452_apex_50k_daily_summary.csv")
output_csv_trades = Path("v452_apex_50k_trade_log.csv")
