...
from src.strategies.manual.ict_multi_setup_nq_v3 import ICT_MULTI_SETUP_NQ_V3
...
print("\n5) Debug counters...")
for k, v in ICT_MULTI_SETUP_NQ_V3.last_debug_counts.items():
    print(f"{k}: {v}")

print("\n6) Trade metadata log...")
if ICT_MULTI_SETUP_NQ_V3.last_trade_log:
    meta_df = pd.DataFrame(ICT_MULTI_SETUP_NQ_V3.last_trade_log)
