...
PROP_FIRM_PROFILES: Dict[str, PropFirmProfile] = {
    ...
    "ftmo_100k_template": PropFirmProfile(name="ftmo_100k_template", starting_balance=100_000.0, daily_loss_limit=-5_000.0, allow_overnight=False, notes="Template profile. Fill exact FTMO rules before production use."),
}
