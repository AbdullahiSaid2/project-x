# ============================================================
# 🌙 Sweep Rejection — Toptick Type 1 (ICT)
# Symbol: MNQ | Timeframe: 5m
# Kill zones: Asian, London, NY AM, NY PM + Macros
#
# LOGIC:
#   Short: wick above 20-bar high, candle closes back below (rejection)
#          + CISD- (close below open of first up candle in sequence)
#   Long:  wick below 20-bar low, candle closes back above (rejection)
#          + CISD+ (close above open of first down candle in sequence)
# ============================================================
